...
import { Link, HorizontalRule, Selection, Color, UnsetAllMarks, ResetMarksOnEnter } from "@/components/ui/tiptap-text-editor/extensions";
...
export const useMinimalTiptapEditor = ({ value, output = "html", placeholder = "", editorClassName, throttleDelay = 1000, onUpdate, onBlur, ...props }: UseMinimalTiptapEditorProps) => {
