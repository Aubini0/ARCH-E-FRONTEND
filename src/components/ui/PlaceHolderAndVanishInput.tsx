  ...
  return (
    ...
    >
      ...
      <button
        ...
        type="button"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full cursor-pointer transition duration-200 flex items-center justify-center text-lg bg-transparent md:hover:bg-background"
      >
        {icon}
      </button>
